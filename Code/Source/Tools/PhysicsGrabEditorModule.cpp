...
namespace PhysicsGrab
{
    ...
    public:
        ...
        AZ_CLASS_ALLOCATOR(PhysicsGrabEditorModule, AZ::SystemAllocator);

        PhysicsGrabEditorModule()
        {
...
#else
AZ_DECLARE_MODULE_CLASS(Gem_PhysicsGrab_Editor, PhysicsGrab::PhysicsGrabEditorModule)
#endif
