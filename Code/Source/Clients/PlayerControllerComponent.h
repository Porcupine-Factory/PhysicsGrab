...
namespace ObjectInteraction
{
    ...
    const StartingPointInput::InputEventNotificationId MoveBackEventId("move backward");
    const StartingPointInput::InputEventNotificationId MoveRightEventId("move right");
    const StartingPointInput::InputEventNotificationId MoveLeftEventId("move left");
    const StartingPointInput::InputEventNotificationId RotatePitchEventId("rotate pitch");
    ...
    {
    public:
        AZ_COMPONENT(PlayerControllerComponent, "{3C83168C-1BED-4D48-924D-6848DBA59B18}");
