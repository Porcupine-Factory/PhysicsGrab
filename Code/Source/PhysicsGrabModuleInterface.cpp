...
{
    AZ_TYPE_INFO_WITH_NAME_IMPL(PhysicsGrabModuleInterface,
        "PhysicsGrabModuleInterface", PhysicsGrabModuleInterfaceTypeId);
    ...
    PhysicsGrabModuleInterface::PhysicsGrabModuleInterface()
    {
        ...
        m_descriptors.insert(m_descriptors.end(), {
            PhysicsGrabSystemComponent::CreateDescriptor(),
            PhysicsGrabComponent::CreateDescriptor()
            });
    }
